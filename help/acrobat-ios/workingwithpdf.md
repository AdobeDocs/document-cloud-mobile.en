...
Your file is automatically uploaded to Document Cloud so that it's available on  any device.
   ...
   >[!NOTE]
   >
   > For details about sharing and review workflows, see [Sharing Files and Starting Reviews](review.html). 
...
iPad users with a subscription to the edit service can modify PDF files. See [Edit PDF](editpdf.html) for details about changing font styles, colors, size, alignment, and other features. 
